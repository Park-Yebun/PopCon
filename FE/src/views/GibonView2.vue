...
<template>
  ...
  <div id="bottomSheet" class="bottom_sheet">
    ...
    <div class="bottom_box">
      <div class="card" style="width: 300px; height: 275px; position: relative">
        <img
        ...
        <h2 style="position: absolute; top: 0; left: 0">
          <span class="badge text-bg-light">2월 2일</span>
        </h2>
        <!-- 좌측 상단 날짜 -->
      ...
      <p>
        ...
        expedita tempora autem cumque in soluta recusandae, ex corporis
        reiciendis cupiditate id quo dolores qui veritatis quasi atque illum
        facilis sapiente?
      </p>
      <p>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore
