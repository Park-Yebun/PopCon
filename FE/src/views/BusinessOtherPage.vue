<template>
  <div class="home-container">
    ...
    <div class="content">
      <p class="welcome-text">POPCON 기업님</p>
      ...
      <div class="button-container">
        <button @click="handleButtonClick(1)">기업정보<br>수정</button>
        <button @click="handleButtonClick(2)">체험단<br>정보관리</button>
        <button @click="handleButtonClick(3)">팝업스토어<br>리뷰관리</button>
        <button @click="handleButtonClick(4)">공지사항</button>
        <button @click="handleButtonClick(5)">팝콘<br>1:1 문의</button>
        <button @click="handleButtonClick(6)">기업문의<br>FAQ</button>
      </div>
      ...
      <div class="button-container2">
        <button @click="handleButtonClick(2)">광고 문의</button>
        <button @click="handleButtonClick(3)">푸쉬 알림요청</button>
      </div>
      <br />
      <br />
      <br />
